    ...
    namespace {
        ...
        TEST_CASE("Runtime Save diagnostics classify every canonical failure category", "[save][diagnostics]") {
            const std::array cases{
                ...
                std::pair{&SaveErrors::StoragePermissionDenied, SaveFailureCategory::Storage},
                std::pair{&SaveErrors::StorageReadOnly, SaveFailureCategory::Storage},
                std::pair{&SaveErrors::StorageVolumeUnavailable, SaveFailureCategory::Storage},
                std::pair{&SaveErrors::StorageTransientIo, SaveFailureCategory::Storage},
                std::pair{&SaveErrors::StoragePermanentIo, SaveFailureCategory::Storage},
