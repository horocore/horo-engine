...
namespace Horo::Runtime {
    namespace {
        ...
        const std::array kPolicies{
            ...
            DiagnosticPolicy{&SaveErrors::MigrationDefinitionInvalid, Validation},
            DiagnosticPolicy{&SaveErrors::MigrationRegistryClosed, Lifecycle},
            DiagnosticPolicy{&SaveErrors::MigrationDuplicateIdentity, Validation},
            DiagnosticPolicy{&SaveErrors::MigrationDuplicateEdge, Validation},
            DiagnosticPolicy{&SaveErrors::MigrationBackwardEdge, Validation},
            DiagnosticPolicy{&SaveErrors::MigrationPathMissing, Compatibility},
            DiagnosticPolicy{&SaveErrors::MigrationCycle, Validation},
            DiagnosticPolicy{&SaveErrors::MigrationAmbiguous, Compatibility},
            DiagnosticPolicy{&SaveErrors::MigrationCheckpointInvalid, Compatibility},
            DiagnosticPolicy{&SaveErrors::MigrationCheckpointNotEquivalent, Compatibility},
            DiagnosticPolicy{&SaveErrors::MigrationUnsupportedNewer, Compatibility},
            DiagnosticPolicy{&SaveErrors::MigrationSourceUnsupported, Compatibility},
            DiagnosticPolicy{&SaveErrors::MigrationPlanInvalid, Validation},
            DiagnosticPolicy{&SaveErrors::MigrationCandidateInvalid, Corruption},
            DiagnosticPolicy{&SaveErrors::MigrationStepFailed, Participant},
            DiagnosticPolicy{&SaveErrors::MigrationLimitExceeded, Quota},
            DiagnosticPolicy{&SaveErrors::MigrationSourceMutated, Corruption},
            DiagnosticPolicy{&SaveErrors::MigrationAllocationFailed, Quota},
            ...
            DiagnosticPolicy{&SaveErrors::SlotRecoveryLimitExceeded, Quota},
            DiagnosticPolicy{&SaveErrors::SlotRecoveryAllocationFailed, Quota},
