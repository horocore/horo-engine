    ...
    namespace {
        ...
        const auto &DiagnosticDescriptors() noexcept {
            static const std::array descriptors{
                ...
                &UiErrors::StyleInvalid,
                &UiErrors::StyleIdentityConflict,
                &UiErrors::StyleReferenceInvalid,
                &UiErrors::StyleTypeMismatch,
                &UiErrors::StyleCycle,
                &UiErrors::StyleStateInvalid,
                &UiErrors::StyleSourceStale,
                &UiErrors::StyleSnapshotStorageExhausted,
                &UiErrors::StyleLifecycleUnavailable,
