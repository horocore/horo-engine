    ...
    namespace {
        ...
        const auto &DiagnosticDescriptors() noexcept {
            static const std::array descriptors{
                ...
                &UiErrors::AccessibilitySchemaInvalid,
                &UiErrors::AccessibilityRoleInvalid,
                &UiErrors::AccessibilityStateInvalid,
                &UiErrors::AccessibilityValueInvalid,
                &UiErrors::AccessibilityRangeInvalid,
                &UiErrors::AccessibilitySelectionInvalid,
                &UiErrors::AccessibilityTextInvalid,
                &UiErrors::AccessibilityNameMissing,
                &UiErrors::AccessibilityRelationInvalid,
                &UiErrors::AccessibilityActionInvalid,
                &UiErrors::AccessibilityContributorInvalid,
                &UiErrors::AccessibilitySnapshotInvalid,
                &UiErrors::AccessibilitySnapshotSourceStale,
                &UiErrors::AccessibilitySnapshotStorageExhausted,
                &UiErrors::AccessibilityLifecycleUnavailable,
                &UiErrors::AccessibilityActionStale,
                &UiErrors::AccessibilityActionRejected,
                &UiErrors::AccessibilityFocusConflict,
            };
            return descriptors;
        }
