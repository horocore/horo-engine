...
namespace Horo::Runtime::Ui::UiErrors {
    ...
    const ErrorCodeDescriptor GlyphAtlasInputInvalid{UiDomain,
    ...
    const ErrorCodeDescriptor GlyphAtlasFallbackUnavailable{UiDomain,
    ...
    const ErrorCodeDescriptor GlyphAtlasUploadInvalidTransition{UiDomain,
