...
namespace Horo::Runtime::Ui::UiErrors {
    ...
    const ErrorCodeDescriptor TextLayoutInputInvalid{UiDomain,
    ...
    const ErrorCodeDescriptor TextLayoutCapacityExceeded{UiDomain,
    ...
    const ErrorCodeDescriptor TextLayoutEllipsisInvalid{UiDomain,
    ...
    const ErrorCodeDescriptor TextLayoutStorageExhausted{UiDomain,
    ...
    const ErrorCodeDescriptor TextLayoutLifecycleUnavailable{UiDomain,
