...
namespace Horo::PCG::PCGErrors {
    ...
    const ErrorCodeDescriptor AsyncInvalid{.domain = PcgDomain,
                                           .code = ErrorCode{"pcg.async.invalid"},
                                           .defaultSeverity = ErrorSeverity::Error,
                                           .summary = "The PCG async operation or exact fence is invalid.",
                                           .remediationHint = "Supply complete owner identities, revisions, digest, and owned callbacks."};
    const ErrorCodeDescriptor AsyncUnknown{.domain = PcgDomain,
                                           .code = ErrorCode{"pcg.async.unknown"},
                                           .defaultSeverity = ErrorSeverity::Error,
                                           .summary = "The PCG async operation or scope is unknown.",
                                           .remediationHint = "Use a registered exact scene/cell/graph scope and accepted operation ID."};
    const ErrorCodeDescriptor AsyncClosed{.domain = PcgDomain,
                                          .code = ErrorCode{"pcg.async.closed"},
                                          .defaultSeverity = ErrorSeverity::Warning,
                                          .summary = "PCG async admission or publication is closed.",
                                          .remediationHint = "Wait for scope retirement or activate a new host generation."};
    const ErrorCodeDescriptor AsyncStale{.domain = PcgDomain,
                                         .code = ErrorCode{"pcg.async.stale"},
                                         .defaultSeverity = ErrorSeverity::Warning,
                                         .summary = "Captured PCG async evidence is no longer current.",
                                         .remediationHint = "Recapture exact graph source, input, plan, runtime, and authority evidence."};
    const ErrorCodeDescriptor AsyncCapacityExceeded{.domain = PcgDomain,
                                                    .code = ErrorCode{"pcg.async.capacity_exceeded"},
                                                    .defaultSeverity = ErrorSeverity::Error,
                                                    .summary = "PCG async work exceeds its finite admitted capacity.",
                                                    .remediationHint = "Drain retained work or lower the requested work charge."};
    const ErrorCodeDescriptor AsyncWrongThread{.domain = PcgDomain,
                                               .code = ErrorCode{"pcg.async.wrong_thread"},
                                               .defaultSeverity = ErrorSeverity::Error,
                                               .summary = "PCG async owner state was accessed from another thread.",
                                               .remediationHint = "Advance, invalidate, and publish on the creating owner lane."};
    const ErrorCodeDescriptor AsyncNotReady{.domain = PcgDomain,
